      ...
      //Initiate an image viewer
        ...
        while(!vpDisplay::getClick(I, false) && ros::ok()){
          try {
            ...
            point[0].set_x(-0.269642);
            point[0].set_y(-0.397292);
            point[1].set_x(-0.3343);
            point[1].set_y(-0.0760419);
            point[2].set_x(0.354937);
            point[2].set_y(-0.0609412);
            point[3].set_x(0.308907);
            point[3].set_y(-0.392029);         
            ...
            if (flag == 1)
            {
                for (unsigned int i = 0; i < 4; i++) {
                    ...
                    vpFeatureBuilder::create(p[i], cam, dot_object_1[i]);
